...
public:
    ...
    QString name_getFilePart() const { return "getFilePart"; }
    Q_INVOKABLE qint64 getFilePart(QString path, qlonglong offset, int limit, QObject *base = 0, Callback<QByteArray> callBack = 0, qint32 priority = ASM_DEFAULT_PRIORITY) {
        qint64 id = pushRequest("getFilePart", QVariantList() << QVariant::fromValue<QString>(path) << QVariant::fromValue<qlonglong>(offset) << QVariant::fromValue<int>(limit), priority, true);
        _calls[id] = "getFilePart";
        pushBase(id, base);
        callBackPush<QByteArray>(id, callBack);
        return id;
    }

    QString name_getFileBigPart() const { return "getFileBigPart"; }
    Q_INVOKABLE qint64 getFileBigPart(QString path, qlonglong offset, int limit, QObject *base = 0, Callback<qlonglong> callBack = 0, qint32 priority = ASM_DEFAULT_PRIORITY) {
        qint64 id = pushRequest("getFileBigPart", QVariantList() << QVariant::fromValue<QString>(path) << QVariant::fromValue<qlonglong>(offset) << QVariant::fromValue<int>(limit), priority, true);
        _calls[id] = "getFileBigPart";
        pushBase(id, base);
        callBackPush<qlonglong>(id, callBack);
        return id;
    }

    QString name_getBigFileCancel() const { return "getBigFileCancel"; }
    Q_INVOKABLE qint64 getBigFileCancel(qlonglong _id, QObject *base = 0, Callback<bool> callBack = 0, qint32 priority = ASM_DEFAULT_PRIORITY) {
        qint64 id = pushRequest("getBigFileCancel", QVariantList() << QVariant::fromValue<qlonglong>(_id), priority, true);
        _calls[id] = "getBigFileCancel";
        pushBase(id, base);
        callBackPush<bool>(id, callBack);
        return id;
    }

    QString name_getFileDetails() const { return "getFileDetails"; }
    Q_INVOKABLE qint64 getFileDetails(QString path, QObject *base = 0, Callback<QVariantMap> callBack = 0, qint32 priority = ASM_DEFAULT_PRIORITY) {
        qint64 id = pushRequest("getFileDetails", QVariantList() << QVariant::fromValue<QString>(path), priority, true);
        _calls[id] = "getFileDetails";
        pushBase(id, base);
        callBackPush<QVariantMap>(id, callBack);
        return id;
    }

    QString name_writeToFile() const { return "writeToFile"; }
    Q_INVOKABLE qint64 writeToFile(QString fileId, int offset, QByteArray data, QObject *base = 0, Callback<bool> callBack = 0, qint32 priority = ASM_DEFAULT_PRIORITY) {
        qint64 id = pushRequest("writeToFile", QVariantList() << QVariant::fromValue<QString>(fileId) << QVariant::fromValue<int>(offset) << QVariant::fromValue<QByteArray>(data), priority, true);
        _calls[id] = "writeToFile";
        pushBase(id, base);
        callBackPush<bool>(id, callBack);
        return id;
    }

    QString name_finishWriteFile() const { return "finishWriteFile"; }
    Q_INVOKABLE qint64 finishWriteFile(QString fileId, QObject *base = 0, Callback<bool> callBack = 0, qint32 priority = ASM_DEFAULT_PRIORITY) {
        qint64 id = pushRequest("finishWriteFile", QVariantList() << QVariant::fromValue<QString>(fileId), priority, true);
        _calls[id] = "finishWriteFile";
        pushBase(id, base);
        callBackPush<bool>(id, callBack);
        return id;
    }

    QString name_checkPermission() const { return "checkPermission"; }
    Q_INVOKABLE qint64 checkPermission(QString path, QObject *base = 0, Callback<bool> callBack = 0, qint32 priority = ASM_DEFAULT_PRIORITY) {
        qint64 id = pushRequest("checkPermission", QVariantList() << QVariant::fromValue<QString>(path), priority, true);
        _calls[id] = "checkPermission";
        pushBase(id, base);
        callBackPush<bool>(id, callBack);
        return id;
    }
...
protected:
    ...
    void processSignals(const QString &method, const QVariantList &args) {
        if(method == "getFileBigPartResult") {

#ifndef ASEMANREMOTEFILECORE_H
#define ASEMANREMOTEFILECORE_H
...
class ASEMANCLIENTLIBSHARED_EXPORT AsemanRemoteFileCore : public QObject
{
    Q_OBJECT
...
public:
    ...
    AsemanRemoteFileCore(QObject *parent = Q_NULLPTR);
    virtual ~AsemanRemoteFileCore();
